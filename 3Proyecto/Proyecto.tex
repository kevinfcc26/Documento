...
\section{Desarrollo del Hardware}
    \subsection{Configuración inicial}
        ...
        \begin{figure}[H]
            \begin{center}
                \includegraphics[width = 7cm]{3Proyecto/configuration}
    ...
    \subsection{Caracterizaci\'on de la resistencia Shunt}
        ...
        \subsubsection{Shunt A}
            ...
            \begin{figure}
                \begin{center}
                    \includegraphics[width = 10cm]{3Proyecto/CorrienteVoltaje1.png}
        ...
        \subsubsection{Shunt B}    
            \begin{table} [H]
                \begin{center}
                    ...
                    \end{tabular}
                \end{center}
                \caption{Autor - Corriente vs Voltaje en la resistencia shunt B}
                \label{tab:shuntB}
            \end{table}
            ...
            \begin{figure}[H]
                \begin{center}
                    \includegraphics[width = 9cm]{3Proyecto/CorrienteVoltaje2.png}
        ...
        \subsubsection{Shunt C}
            ...
            \begin{figure}[H]
                \begin{center}
                    \includegraphics[width = 9cm]{3Proyecto/CorrienteVoltaje3.png}
    ...
    \subsection{Conversión de voltaje}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width = 12cm]{3Proyecto/divisorVoltaje}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width = 12cm]{3Proyecto/voltageOutput}
    ...
    \subsection{Conversión de corriente}
        ...
        \begin{figure}
            \begin{center}
                \includegraphics[width = 15cm]{3Proyecto/CircuitoCorriente.PNG}
    ...
    \subsection{Frontend Solución en Angular}
        ...
        \begin{figure}
            \begin{center}
                ...
                \caption{Autor - Creación de proyecto en Angular (Terminal del computador)} 
                \label{fig:ngNew}
           \end{center}
        \end{figure}
        \begin{figure}
            \begin{center}
                ...
                \caption{Autor - Levantar servidor local en Angular (Terminal del computador)} 
                \label{fig:ngServe}
           \end{center}
        \end{figure}
