...
\section{Desarrollo del Hardware}
    ...
    \subsection{Conversión de corriente}
        ...
        Remplazando la ecuación \ref{Nodo D en B} en la ecuación \ref{Nodo D en A} para dejar D en terminos de $V_{i}$
        \begin{align*}
        ...
        Con ayuda de Matlab se resuelve la ecuacion dejandola en terminos de $I = f(ADCI) $.
        \begin{itemize}
            \item \textbf{Shunt A} 
                \begin{lstlisting}
