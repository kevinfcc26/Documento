...
Para simplificar el circuito electrónico se remplaza el filtro de ferrita con la resistencia de 1k por R1, y como el valor de los condensadores es el mismo, ambos condensadores se simbolizan con la letra C.
