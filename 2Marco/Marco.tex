...
\begin{longtable}{|l|c|c|c|}
    ...
    MONOFÁSICO TRIFILAR - 1F3H - RYMEL            & NO & NO & \cite{A57} \\ \hline
...
La onda periódica de la corriente $i_{s}(t)$ en la figura \ref{fig:distorsion_current}(a), se puede expresar en componentes de Fourier:\\
...
i^2_{s}=(i_{s1}+ (\sum_{h=2}^{\infty}i_{sh})^2 = i^2_{s1} + \sum_{h=2}^{\infty}i^2_{sh(t)} \\ 
...
\end{equation}
Donde:\\
$\frac{1}{T}\int_{T_{1}}^{}i^2_{s1}(t) \cdot dt = I^2_{s1}$\\\\
...
El factor de potencia se puede interpretar como la razón entre la energía transmitida a la carga sobre la energía máxima que podría transmitirse, siempre y cuando las pérdidas de línea se mantengan iguales.\cite{A30}\\
...
Para un $S$ y $V$ dados, la utilización máxima de la línea es obtenida cuando $P=S$, por lo tanto, la razón $P/S$ es un indicador de factor de utilización.\cite{A30}
 ...
 La potencia compleja, cuya magnitud se conoce como potencia aparente, se expresa como la suma vectorial de la potencia activa (parte real) y la potencia reactiva (parte imaginaría).\cite{A30}
...
\begin{figure}[H]
\centering
\includegraphics[width = 8.9cm]{2Marco/triangulopotencias}
...
\begin{equation}
PF_{1}=cos \theta_{1} = \frac{P_{1}}{S_{1}}
\end{equation}

Este coeficiente, facilita la evaluación de las condiciones del flujo energía. $PF_{1}$ es también conocido cómo factor de desplazamiento\cite{A30}
...
$THD_{V}$ (\%) & 4              & N/A & N/A &  \\ \cline{1-4}
$THD_{I}$ (\%) & 45             & N/A & N/A &  \\ \cline{1-4}
P (W)     & 200,1317       & 200                        & 0,1317                           &  \\ \cline{1-4}
Q (VAR)   & N/A & 40                         & N/A &  \\ \cline{1-4}
S (VA)    & 223,836        & 203,9608                   & 3,671                            &  \\ \cline{1-4}
$S_{N}$ (VA)   & 92,2094        & N/A & N/A &  \\ \cline{1-4}
$D_{I}$ (VA)   & 91,7745        & N/A & N/A &  \\ \cline{1-4}
$D_{V}$ (VA)   & 8,1583         & N/A & N/A &  \\ \cline{1-4}
$\theta$ (°)  & N/A & 11,3044                    & N/A &  \\ \cline{1-4}
PF        & 0,8941         & 0,9805                     & N/A &  \\ \cline{1-4}
N (VAR)   & 100,2489       & N/A & N/A &  \\ \cline{1-4}
$D_{H}$ (VAR)  & 3,6686         & N/A & N/A &  \\ \cline{1-4}
\end{tabular}
\caption{Autor - Resultado del ejemplo monofásico no sinusoidal}
...
\end{tabular}
\end{center}
\caption{Autor - Datos de caracterización de frecuencia}
...
\begin{figure}[H]
\centering
\includegraphics[width = 10cm]{2Marco/voltaje-rms}
\caption{Autor - Voltaje RMS} 
...
\begin{align*}
    ...
    \end{tabular}
    \end{center}
    \caption{Autor - Tabla de rangos máximos y mínimos de VRMS}
...
\end{tabular}
\end{center}
\caption{Autor - Datos de caracterización de corriente}
\label{tab:ejercicio-corriente}
\end{table}
\begin{figure}
    \centering
    \includegraphics[width = 15cm]{2Marco/tension-nominal}
...
\end{tabular}
\end{center}
\caption{Autor - Distorsión armónica en corriente y voltaje}
...
\caption{Autor - Porcentaje de $THD_{V}$ } 
...
\caption{Autor - Porcentaje de $THD_{I}$ } 
...
\end{tabular}
\end{center}
\caption{Autor - TDD de corrientes}
